...
describe('The Todo list renders properly', () => {
  ...
  vm.todos.push({id: 1, title: 'Todo 3', created_at: new Date(), completed: false });
  vm.todos.push({ id: 2, title: 'Todo 3', created_at: new Date(), completed: false });

  it('should render the title', () => {
    expect(vm.$el.querySelector('h1.todos-title').textContent).to.equal('Todos (2)');
  });
});
